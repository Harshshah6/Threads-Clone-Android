...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        data.add(new ThreadModel(
                ...
                "this is sample text written here",
                ""+ (Utils.getNowInMillis() - TimeUnit.DAYS.toMillis(2)),
                new PollOptions(new PollOptions.PollOptionsItem(0,"op1",true), new PollOptions.PollOptionsItem(1,"op2",true), new PollOptions.PollOptionsItem(2,"op3",false), new PollOptions.PollOptionsItem(3,"op4",false)),
                new ArrayList<>(),
                "",
                "i_am_tester",
                new ArrayList<>()
        ...
        images.add("https://raw.githubusercontent.com/square/picasso/refs/heads/master/website/static/sample.png");
        ...
        images.add("https://img.freepik.com/free-photo/medium-shot-man-indoors_23-2151038808.jpg");
    ...
    public static class PostImagesListAdapter extends RecyclerView.Adapter<PostImagesListAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            ShapeableImageView imageView = (ShapeableImageView) holder.itemView;
            if(!data.get(position).isEmpty())
                Picasso.get().load(data.get(position)).placeholder(R.drawable.img).into(imageView);
